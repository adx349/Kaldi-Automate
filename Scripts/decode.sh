  ...
  $cmd JOB=1:$nj $dir/log/decode.JOB.log \
    ...
    --online=$online \
     ...
     $srcdir/${iter}.mdl $graphdir/HCLG.fst $spk2utt_rspecifier "$wav_rspecifier" \
      "ark:|/home/kaldi/src/latbin/lattice-best-path --acoustic-scale=$post_decode_acwt ark:- ark,t:- | utils/int2sym.pl -f 2- data/lang_chain/words.txt >> $output_name.txt" || exit 1;
fi
...
echo "...........IT TOOK $total_time TO EXECUTE THIS SCRIPT"
echo
echo "THE TIMINGS ARE SAVED IN /home/kaldi/LOG/timing.txt"

echo $execute_date, $total_time, $output_name >> /home/kaldi/LOG/timing.txt
